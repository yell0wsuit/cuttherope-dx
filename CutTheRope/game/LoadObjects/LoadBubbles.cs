...
namespace CutTheRope.game
{
    ...
    internal sealed partial class GameScene
    {
        ...
        /// </summary>
        private void LoadBubble(XMLNode xmlNode, float scale, float offsetX, float offsetY, int mapOffsetX, int mapOffsetY)
        {
            ...
            bubble.initial_x = bubble.x = (xmlNode["x"].IntValue() * scale) + offsetX + mapOffsetX;
            bubble.initial_y = bubble.y = (xmlNode["y"].IntValue() * scale) + offsetY + mapOffsetY;
